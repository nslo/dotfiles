...
"}}}
" General colors"{{{
hi  Normal       guifg=#c6c6c6 guibg=#262626 gui=NONE      ctermfg=251   ctermbg=NONE  cterm=NONE
hi  NonText      guifg=#ff00ff guibg=#000000 gui=NONE      ctermfg=13    ctermbg=NONE    cterm=NONE

hi  Cursor       guifg=#000000 guibg=#ffff00 gui=NONE      ctermfg=0     ctermbg=11   cterm=reverse
hi  LineNr       guifg=#3a3a3a guibg=#000000 gui=NONE      ctermfg=237   ctermbg=NONE    cterm=NONE
