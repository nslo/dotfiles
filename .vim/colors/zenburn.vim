...
if &t_Co > 255
    ...
    hi DiffAdd         ctermfg=66    ctermbg=None
    hi DiffChange      ctermbg=None
    hi DiffDelete      ctermfg=236   ctermbg=None
    hi DiffText        ctermfg=217   ctermbg=None
    hi Directory       ctermfg=188   cterm=bold
    hi ErrorMsg        ctermfg=115   ctermbg=None
    hi Exception       ctermfg=249   cterm=bold
    hi Float           ctermfg=251
    hi FoldColumn      ctermfg=109   ctermbg=None
    hi Folded          ctermfg=109   ctermbg=None
    ...
    hi Statement       ctermfg=187   ctermbg=None
    ...
    hi Todo            ctermfg=108   ctermbg=None
    hi Typedef         ctermfg=253   cterm=bold
    hi Type            ctermfg=187   cterm=bold
    hi Underlined      ctermfg=188   ctermbg=None
    hi VertSplit       ctermfg=236   ctermbg=None
    hi VisualNOS       ctermfg=236   ctermbg=None
    ...
    if exists("g:zenburn_high_Contrast")
        hi N237ormal ctermfg=188 ctermbg=None
    ...
    if exists("g:zenburn_alternate_Error")
        ...
        hi Error ctermfg=228 ctermbg=None
    endif
endif
