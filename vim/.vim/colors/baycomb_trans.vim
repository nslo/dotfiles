...
hi Cursor ctermfg=black ctermbg=NONE
...
if &term == "builtin_gui" || &term == "win32"
	...
	hi IncSearch	ctermfg=black ctermbg=NONE cterm=NONE
	hi Search	ctermfg=black ctermbg=NONE cterm=NONE
else
...
hi PmenuSel     ctermbg=NONE ctermfg=white                    

hi tablinesel   ctermfg=cyan ctermbg=NONE
hi tabline      ctermfg=black ctermbg=NONE
hi tablinefill  ctermfg=green ctermbg=NONE
"vim: sw=4
"
hi MatchParen	ctermfg=black ctermbg=NONE
...
hi SpecialKey	ctermfg=darkgreen
hi NonText	cterm=bold ctermfg=darkgrey ctermbg=NONE
hi Directory	ctermfg=darkcyan
hi ErrorMsg	cterm=bold ctermfg=7 ctermbg=NONE
hi IncSearch	ctermfg=yellow ctermbg=NONE cterm=NONE
...
hi StatusLineNC ctermfg=grey ctermbg=NONE cterm=NONE
hi VertSplit	ctermfg=black ctermbg=NONE cterm=NONE
hi Title	ctermfg=darkyellow ctermbg=NONE
hi Visual	ctermbg=NONE ctermfg=cyan cterm=NONE
...
hi Underlined	ctermfg=black ctermbg=NONE
hi Ignore	cterm=bold ctermfg=7
hi Ignore	ctermfg=darkgrey
hi Error	cterm=bold ctermfg=7 ctermbg=NONE
